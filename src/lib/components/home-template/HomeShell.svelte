...
<div class="template-shell">
	<div class="template-shell__inner">
		<header class="template-shell__header">
			...
			>
				<svg viewBox="0 0 24 24" aria-hidden="true" class="template-shell__theme-icon template-shell__theme-icon--moon">
					<path
						d="M17.75 15.5a.75.75 0 0 1 .67 1.09A8.25 8.25 0 1 1 7.41 5.58a.75.75 0 0 1 1.09.67 7 7 0 0 0 9.25 9.25Z"
						fill="currentColor"
					/>
				</svg>
				<svg viewBox="0 0 24 24" aria-hidden="true" class="template-shell__theme-icon template-shell__theme-icon--sun">
					<path
...
<style>
	...
	.template-shell__theme-icon--sun {
		display: none;
	}

	:global(html.dark) .template-shell__theme-icon--moon {
		display: block;
	}

	:global(html.dark) .template-shell__theme-icon--sun {
		display: none;
	}

	:global(html:not(.dark)) .template-shell__theme-icon--moon {
		display: none;
	}

	:global(html:not(.dark)) .template-shell__theme-icon--sun {
		display: block;
	}
