...
<script lang="ts">
	...
	import { avatar, authorName, bio } from '$lib/info.js';
	...
	export let latestBlogPosts: WritingPost[] = [];
	export let latestFieldNotes: WritingPost[] = [];
...
<div class="home-page">
	...
	{#if showPhotos && latestPhotos.length}
