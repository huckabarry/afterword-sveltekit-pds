...
<section class="stream-head">
	...
	<p class="stream-head__lede">
		Short notes, links, gardening thoughts, music references, minor victories, and other things too
		small or immediate to become a full post. Think of it as the messier but still useful studio
		wall version of the site.
	</p>
</section>
