			...
			<div class="status-row__actions">
				...
				<div class="status-row__reply-pills">
					...
					>
						<span class="status-row__reply-pill-icon" aria-hidden="true">
							<svg viewBox="0 0 24 24" focusable="false">
								<path d="M12 2.75c-4.97 0-9 3.64-9 8.13 0 2.56 1.31 4.84 3.37 6.33L5.5 20.5l3.18-1.74c1.02.29 2.12.44 3.32.44 4.97 0 9-3.64 9-8.12 0-4.5-4.03-8.13-9-8.13Zm3.98 10.04h-1.46V9.24c0-.75-.32-1.13-.95-1.13-.7 0-1.05.45-1.05 1.34v1.95h-1.45V9.45c0-.89-.35-1.34-1.05-1.34-.63 0-.95.38-.95 1.13v3.55H7.61V9.13c0-.74.2-1.34.59-1.78.4-.45.94-.68 1.6-.68.77 0 1.34.29 1.73.87l.37.61.37-.61c.38-.58.96-.87 1.72-.87.66 0 1.2.23 1.6.68.4.44.59 1.04.59 1.78v3.66Z"></path>
							</svg>
						</span>
