...
import { getReblogActivityId, unreblogObject } from '$lib/server/mastodon-state';
...
export async function POST(event) {
	...
	const activityId = await getReblogActivityId(event, objectId);
	...
	await unreblogObject(event, objectId);
