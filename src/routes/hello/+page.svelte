...
<svelte:head>
	<title>{data.page?.title || 'Hello'} | Bryan Robb</title>
	<meta
		name="description"
		content={data.page?.summary ||
...
<section class="section-block hello-page">
	<h1 class="section-title">{data.page?.title || 'Hello'}</h1>
				...
				{:else}
					...
					<ul class="hello-page__list">
						...
						<li>
							...
							email through
							<a href="https://lowvelocity.org" target="_blank" rel="noreferrer">Low Velocity</a>.
						</li>
						<li>
